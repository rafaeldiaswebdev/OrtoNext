                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nome" id="nome" value="<?= $dentista->nome ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">CRO</label>
                                <input type="text" class="form-control" name="cro" id="cro" value="<?= $dentista->cro ?>" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="cpf" id="cpf" value="<?= $dentista->cpf ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">E-mail</label>
                                <input type="email" class="form-control" name="email" id="email" value="<?= $dentista->email ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">Especialidade</label>
                                <input type="text" class="form-control" name="especialidade" id="especialidade" value="<?= $dentista->especialidade ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="telefone" id="telefone" value="<?= $dentista->telefone ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">WhatsApp</label>
                                <input type="text" class="form-control" name="whatsapp" id="whatsapp" value="<?= $dentista->whatsapp ?>">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <?php foreach ($clinicas as $clinica): ?>
                                    <div class="col-md-6 mb-2">
                                        <label class="form-check">
                                            <input type="checkbox" class="form-check-input" name="clinicas[]" value="<?= $clinica->id ?>" <?= in_array($clinica->id, $clinicas_vinculadas_ids) ? 'checked' : '' ?>>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">
                                    <?= $dentista->foto ? 'Alterar Foto' : 'Foto do Dentista' ?>
                                </label>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="observacoes" rows="4"><?= $dentista->observacoes ?></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-check form-switch">
                            <input type="hidden" name="status" value="0">
                            <input type="checkbox" class="form-check-input" name="status" value="1" <?= $dentista->status == 'ativo' ? 'checked' : '' ?>>
